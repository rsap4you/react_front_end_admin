      ...
      <div className="col-lg-4">
        <div className="card">
          <div className="card-body p-4">
            <div className="error-ghost text-center">
              <svg className="ghost" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="127.433px" height="132.743px" viewBox="0 0 127.433 132.743" enableBackground="new 0 0 127.433 132.743" xmlSpace="preserve">
            ...
            <div className="text-center">
              ...
              <p className="text-muted mb-0">It's looking like you may have taken a wrong turn. Don't worry...
        ...
        <div className="row mt-3">
          <div className="col-12 text-center">
            <p className="text-white-50">Return to <a href="index.html" className="text-white ms-1"><b>Home</b></a></p>
          </div> {/* end col */}
        </div>
        {/* end row */}
      </div> {/* end col */}
